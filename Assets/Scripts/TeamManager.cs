...
public class TeamManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        for (int i = 0; i < NumAgents; i++)
        {
            ...
            myAgentTeam1.isEnemyPlayer = this.isEnemyPlayer;
            ...
            myAgentTeam2.isEnemyPlayer = this.isEnemyPlayer;
    ...
    void FixedUpdate()
    {
        if (isTraining)
        {
            ...
            if (m_ResetTimer >= MaxEnvironmentSteps && MaxEnvironmentSteps > 0)
            {
                ...
                m_AgentGroup1.GroupEpisodeInterrupted();
                m_AgentGroup2.GroupEpisodeInterrupted();
